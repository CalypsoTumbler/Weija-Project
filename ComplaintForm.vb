...
Public Class ComplaintForm
    ...
    Private Function MyInputBox(ByVal Prompt As String) As String
        ...
        frmInput.Text = "Enter Receiver Code"
        txtbox.PasswordChar = "*"
        frmInput.ShowDialog()
        Return txtbox.Text
    End Function
        ...
        Try
            ...
            Else
                ...
                Else
                    ...
                    Dim query = "select * from ReceiverTbl where ReceiverCode = '" & Receiver & "'"
                    ...
                    Else
                        Dim Query2 = "select ReceiverName from ReceiverTbl where ReceiverCode = '" & Receiver & "'"
